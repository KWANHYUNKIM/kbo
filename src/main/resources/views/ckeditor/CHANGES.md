...
* [#16639](https://dev.ckeditor.com/ticket/16639): The `callback` parameter in the [`CKEDITOR.ajax.reply()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ajax.html#method-reply) method became optional.
